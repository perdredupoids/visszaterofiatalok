            ...
            <div class="header__content row">
                ...
                <nav class="header__nav-wrap">
                    ...
                    <ul class="header__nav">
                        ...
                        <li class="current"><a href="blog.php">Article</a></li>
                    ...
                    <div class="featured__column featured__column--big">
                        <div class="entry" style="background-image:url('./assets/images/hipcravo-5ubiqv58cw8-unsplash.jpg');">
                            ...
                            <div class="entry__content">
                                <h1><a href="9MAPuBMwgfUxb6Jv9VugLw9iUc.php" title="">Qu'est-ce que la Gymnastique(gymnastique)?</a></h1>
                    ...
                    <div class="featured__column featured__column--small">
                        ...
                        <div class="entry" style="background-image:url('./assets/images/bruce-mars-hhxdpg_etiq-unsplash.jpg');">
                            ...
                            <div class="entry__content">
                                ...
                                <h1><a href="386958df5bae3452f1247ddc6fa09bab.php" title="">Comment obtenir rapidement votre corps e...</a></h1>
                        ...
                        <div class="entry" style="background-image:url('./assets/images/camila-quintero-franco-rt9zmfg3nn8-unsplash.jpg');">
                            ...
                            <div class="entry__content">
                                ...
                                <h1><a href="BFLgf2QpVqDCWG8GHiKsQUqdD5.php" title="">Perdre du poids à la maison en 5 MINUTES</a></h1>
            ...
            <div class="masonry">
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        <a href="9MAPuBMwgfUxb6Jv9VugLw9iUc.php" class="entry__thumb-link">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">Qu'est-ce que la Gymnastique(gymnastique...</a></h1>
                        </div>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        <a href="386958df5bae3452f1247ddc6fa09bab.php" class="entry__thumb-link">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            <div class="entry__date">11.02.2021</a></div>
                            <h1 class="entry__title"><a href="single.php">Comment obtenir rapidement votre corps e...</a></h1>
                        </div>
                        <div class="entry__excerpt">
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__thumb">
                        <a href="BFLgf2QpVqDCWG8GHiKsQUqdD5.php" class="entry__thumb-link">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            <div class="entry__date">11.02.2021</a></div>
                            <h1 class="entry__title"><a href="single.php">Perdre du poids à la maison en 5 MINUTES</a></h1>
                        </div>
                        <div class="entry__excerpt">
